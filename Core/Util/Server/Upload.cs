...
{
    /// <summary>
    /// This class contains methods taken from Salient.Web.HttpLib.HttpRequestUtility
    ...
    public static class Upload
    {
        ...
        /// 
        private static WebResponse PostFile
        ...
        NameValueCollection headers)
        {
            ...
            if (fileData != null)
            {
                ...
                sbHeader.AppendFormat("Content-Disposition: form-data; name=\"{0}\"; {1}\r\n", fileFieldName,
                    string.IsNullOrEmpty(fileName) ? "" : string.Format(CultureInfo.InvariantCulture, 
            ...
            NameValueCollection headers)
        {
            ...
            (fileName, FileMode.Open, FileAccess.Read, FileShare.Read))
            {
                return PostFile(requestUri, postData, fileData, 
                    fileName, fileContentType, fileFieldName, cookies, headers);
            }
        }
        /// <summary>
