...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib advapi32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib oledlg.lib /nologo /base:"0x22000000" /version:1.0 /subsystem:windows /dll /pdb:none /map /machine:I386 /out:"Release/dsoframer.ocx" /opt:nowin98 /merge:.rdata=.text
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib advapi32.lib ole32.lib oleaut32.lib uuid.lib comdlg32.lib oledlg.lib /nologo /version:1.1 /subsystem:windows /dll /map /debug /machine:I386 /out:"Debug/dsoframer.ocx" /pdbtype:con
